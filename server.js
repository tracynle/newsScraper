...
app.get("/article/:id", function(req,res){
    ...
    console.log("Finds article by id: ", req.params.id);
});
// ========== //
// CODE DID NOT WORK ======= ASK WHY WE COULDN'T SEND THE JSON BACK? BC OF A QUERY? 
// BUT IN SOLVED HAS THE .THEN FUNCTION THAT SENT THE ARTICLES BUT THE CODE BELOW SENT A QUERY
...
//         res.json(err);
//     });
//     console.log("This is the note after it was created with the POST", req.body);
// });
